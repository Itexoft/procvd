...
public sealed class ProcessOutputFormatter(ProcessOutputFormatterOptions? options = null)
{
    ...
    public string Format(ProcessOutputLine line)
    {
        ...
        this.AppendPrefix(builder, line.Timestamp, line.Process, line.DisplayPath);
        builder.Append('[');
    ...
    public string Format(ProcessOutputEvent message)
    {
        ...
        this.AppendPrefix(builder, message.Timestamp, message.Process, message.DisplayPath);
    ...
    private void AppendPrefix(StringBuilder builder, DateTimeOffset timestamp, ProcessKey process, string displayPath)
    {
        builder.Append('[');
