...
public class ProcessConfigResolverTests
{
    ...
    public void Resolve_OutputFileDefaults()
    {
        ...
        var expectedLog = Path.Combine(Path.GetFullPath(baseDirectory), "procvd-logs", "core", "app.log");
    ...
    [Test]
    public void Resolve_RunAsUserOverrides()
    {
        var config = new ProcessConfig
        {
            Defaults = new ProcessSettings
        ...
        Assert.That(process.RunAsUser, Is.EqualTo("process-user"));
    }
}
